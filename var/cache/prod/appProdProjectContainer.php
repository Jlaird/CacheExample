...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bugsnag' => 'getBugsnagService',
            'bugsnag.factory' => 'getBugsnag_FactoryService',
            'bugsnag.listener' => 'getBugsnag_ListenerService',
            'bugsnag.resolver' => 'getBugsnag_ResolverService',
    ...
    /*
     * Gets the 'bugsnag' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bugsnag\Client A Bugsnag\Client instance
     */
    protected function getBugsnagService()
    {
        return $this->services['bugsnag'] = $this->get('bugsnag.factory')->make();
    }

    /*
     * Gets the 'bugsnag.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bugsnag\BugsnagBundle\DependencyInjection\ClientFactory A Bugsnag\BugsnagBundle\DependencyInjection\ClientFactory instance
     */
    protected function getBugsnag_FactoryService()
    {
        return $this->services['bugsnag.factory'] = new \Bugsnag\BugsnagBundle\DependencyInjection\ClientFactory($this->get('bugsnag.resolver'), '46cdbefafe0c4082c72a186e783d382d', false, true, NULL, NULL, true, NULL, true, NULL, NULL, ($this->targetDirs[3].'/app'), 'prod', array(), array());
    }

    /*
     * Gets the 'bugsnag.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bugsnag\BugsnagBundle\EventListener\BugsnagListener A Bugsnag\BugsnagBundle\EventListener\BugsnagListener instance
     */
    protected function getBugsnag_ListenerService()
    {
        return $this->services['bugsnag.listener'] = new \Bugsnag\BugsnagBundle\EventListener\BugsnagListener($this->get('bugsnag'), $this->get('bugsnag.resolver'), true);
    }

    /*
     * Gets the 'bugsnag.resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bugsnag\BugsnagBundle\Request\SymfonyResolver A Bugsnag\BugsnagBundle\Request\SymfonyResolver instance
     */
    protected function getBugsnag_ResolverService()
    {
        return $this->services['bugsnag.resolver'] = new \Bugsnag\BugsnagBundle\Request\SymfonyResolver();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('U4fU7PtA4X', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pdmn9RBZPp', 0, 'HlriBv5POE5BTMQNsyGwQw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qQccXCdhYW', 0, 'HlriBv5POE5BTMQNsyGwQw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_414e54a694ec72bd4b4e691a73bc8383f68ea23abda70b353b9a02b4629056d0');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'bugsnag.listener', 1 => 'onKernelRequest'), 256);
        $instance->addListenerService('kernel.exception', array(0 => 'bugsnag.listener', 1 => 'onKernelException'), 128);
        $instance->addListenerService('console.exception', array(0 => 'bugsnag.listener', 1 => 'onConsoleException'), 128);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/bugsnag/bugsnag-symfony/Resources/views'), 'Bugsnag');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f2b54512400f844582138fac22e659374bfc9a0a');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vNV7iNQEDa', 0, 'HlriBv5POE5BTMQNsyGwQw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5817aa39c7feb6.48182140')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BugsnagBundle' => 'Bugsnag\\BugsnagBundle\\BugsnagBundle',
            ),
            ...
            'secret' => 'f2b54512400f844582138fac22e659374bfc9a0a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f2b54512400f844582138fac22e659374bfc9a0a',
            ...
            'validator.mapping.cache.prefix' => 'validator_110fa1e8bf308ca226d2ca760540c9da8e7780d69b41ea4c2d54fb65af450c83',
            ...
            'bugsnag.api_key' => '46cdbefafe0c4082c72a186e783d382d',
            'bugsnag.endpoint' => false,
            'bugsnag.callbacks' => true,
            'bugsnag.app_type' => NULL,
            'bugsnag.app_version' => NULL,
            'bugsnag.batch_sending' => true,
            'bugsnag.hostname' => NULL,
            'bugsnag.send_code' => true,
            'bugsnag.strip_path' => NULL,
            'bugsnag.project_root' => NULL,
            'bugsnag.auto_notify' => true,
            'bugsnag.resolver' => 'Bugsnag\\BugsnagBundle\\Request\\SymfonyResolver',
            'bugsnag.factory' => 'Bugsnag\\BugsnagBundle\\DependencyInjection\\ClientFactory',
            'bugsnag.client' => 'Bugsnag\\Client',
            'bugsnag.listener' => 'Bugsnag\\BugsnagBundle\\EventListener\\BugsnagListener',
            'bugsnag.notify_release_stages' => array(

            ),
            'bugsnag.filters' => array(
