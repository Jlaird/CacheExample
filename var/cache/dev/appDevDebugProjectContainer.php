...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['bugsnag.factory'] = new \Bugsnag\BugsnagBundle\DependencyInjection\ClientFactory($this->get('bugsnag.resolver'), '46cdbefafe0c4082c72a186e783d382d', false, true, NULL, NULL, true, NULL, true, NULL, NULL, ($this->targetDirs[3].'/app'), 'dev', array(), array());
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vbXPw6UOcH', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('olQC4Z94n1', 0, 'e8Ub+1nuXJ99+n0EDOku7w', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+MQBnU3rNP', 0, 'e8Ub+1nuXJ99+n0EDOku7w', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SH2qcQ-t5h', 0, 'e8Ub+1nuXJ99+n0EDOku7w', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7746d2e6bcfadc03c3e4fa6e698f5a03099b086c335d219f80f33baa4a068371');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5817aa33860ec8.97531868')), true);
